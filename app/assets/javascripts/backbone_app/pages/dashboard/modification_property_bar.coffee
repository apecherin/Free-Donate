class Pages.Dashboard.ModificationPropertyBar extends Backbone.Marionette.ItemView
  template: 'pages/dashboard/news_feeds/modification_property_bar'
  className: 'modification-property-bar-container'

  initialize: ({@stockProperty})->
