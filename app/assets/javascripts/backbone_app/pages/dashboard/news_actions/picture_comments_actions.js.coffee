class Pages.Dashboard.NewsActions.PictureCommentsActions extends Backbone.Marionette.Layout
  template: 'pages/dashboard/news_actions/picture_comments_actions'
